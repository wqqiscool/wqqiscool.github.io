...
这他娘的就是java 的运行环境呀！！！！！！，我们再来看看它的父亲类AndroidRuntime类：[platform/framework/base/core/jni/AndroidRuntime.cpp](https://android.googlesource.com/platform/frameworks/base/+/refs/tags/android-8.0.0_r45/core/jni/AndroidRuntime.cpp) [涉及到类目录](https://android.googlesource.com/platform/frameworks/base/+/refs/tags/android-8.0.0_r45/core/java/com/android/internal/os/)
...
好我们先来看`RuntimeInit.applicationInit(targetSdkVersion,argv,classLoader)`，来源自[frameworks/base/core/java/com/android/internal/os/RuntimeInit.java](https://android.googlesource.com/platform/frameworks/base/+/refs/tags/android-8.0.0_r45/core/java/com/android/internal/os/RuntimeInit.java)
...
通过抛出异常，进入到`ZygoteInit.java`中的异常处理，执行`call.run（）`
进入到`SystemServer.java`的main函数中，开启了一系列操作。



再来看方法`nativeZygoteInit()`,显而，这是一个`native`方法，我们回到`native层`对应的方法[frameworks/base/core/jni/AndroidRuntime.cpp](https://android.googlesource.com/platform/frameworks/base/+/refs/tags/android-8.0.0_r45/core/jni/AndroidRuntime.cpp) 中：
